...
ifeq ($(CONFIG_MIPS),y)
    EXTRA_CFLAGS += -DDMA $(WLFLAGS) -I$(src) -I$(src)/.. -I$(SRCBASE)/wl/linux \
		    -I$(SRCBASE)/wl/sys $(WLAN_ComponentIncPath) -I$(srctree)/brcm/mipsel/shared/bcmwifi/include -I$(srctree)/brcm/mipsel/wl/clm/include -I$(srctree)/brcm/mipsel/wl/olpc/include -I$(srctree)/brcm/mipsel/wl/lwip/include -I$(srctree)/brcm/mipsel/dpsta  -I$(srctree)/brcm/mipsel/wl/sys  -I$(srctree)/brcm/mipsel/wl/phy -I$(srctree)/brcm/mipsel/wl/ppr/include
else
    EXTRA_CFLAGS += -DDMA $(WLFLAGS) -I$(src) -I$(src)/.. -I$(SRCBASE)/wl/linux \
		    -I$(SRCBASE)/wl/sys $(WLAN_ComponentIncPath) -I$(srctree)/brcm/arm/shared/bcmwifi/include -I$(srctree)/brcm/arm/wl/clm/include -I$(srctree)/brcm/arm/wl/olpc/include -I$(srctree)/brcm/arm/wl/lwip/include -I$(srctree)/brcm/arm/dpsta  -I$(srctree)/brcm/arm/wl/sys  -I$(srctree)/brcm/arm/wl/phy -I$(srctree)/brcm/arm/wl/ppr/include
endif
